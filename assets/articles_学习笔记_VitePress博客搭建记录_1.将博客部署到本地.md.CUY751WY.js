...
<span class="line"><span>└</span></span></code></pre></div><p>至此一个<code>VitePress</code>项目就新建完成啦！让我们根据提示，试着启动服务：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm run docs:dev</span></span></code></pre></div><p>如果终端输出以下内容，说明后台服务已经成功启动：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&gt; docs:dev</span></span>
